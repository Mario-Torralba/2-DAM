...
CREATE TABLE VENTA(
    ...
    ID_USUARIO_VENDEDOR SMALLSERIAL,
    ID_USUARIO_COMPRADOR SMALLSERIAL,
    ID_PRODUCTO SMALLSERIAL,
    ID_DIRECCION_CLIENTE SMALLSERIAL,
...
ALTER TABLE VENTA
ADD CONSTRAINT FK_VENTA_USUARIO_COMPRADOR FOREIGN KEY (ID_USUARIO_COMPRADOR) REFERENCES USUARIO (ID_USUARIO);
ALTER TABLE VENTA
ADD CONSTRAINT FK_VENTA_USUARIO_VENDEDOR FOREIGN KEY (ID_USUARIO_VENDEDOR) REFERENCES USUARIO (ID_USUARIO);
ALTER TABLE VENTA
